object HigherKindedTypes {
  ...
  def funcLikeMap1(key: Any)(value: Any): Any = ???

  val t: Any => Any = funcLikeMap1("dfd")

  funcLikeFunctor(t)

  type S[D] = Map[String, D]
  val f = new Functor[S]{
    override def fmap[A, B](fa: S[A])(f: A => B) = ???
  }
  /*
